...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 231.0, 524.5, 124.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 168.0, 537.0, 59.0, 22.0 ],
					"text" : "mute 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 456.5, 202.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 7.5, 461.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.5, 535.5, 60.0, 22.0 ],
					"text" : "s mute.all"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 86.0, 144.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 62.0, 137.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 196.0, 38.0, 55.0, 22.0 ],
					"text" : "select all"
				}
...
,
					"patching_rect" : [ 489.0, 348.5, 75.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 397.952475247524944, 348.5, 79.0, 22.0 ],
					"text" : "prepend note"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 572.25, 478.0, 76.0, 22.0 ],
					"text" : "0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 471.0, 478.0, 76.0, 22.0 ],
					"text" : "0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 562.25, 456.0, 61.0, 20.0 ],
					"text" : "busymap"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 449.25, 456.0, 61.0, 20.0 ],
					"text" : "mutemap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 398.0, 478.0, 54.0, 22.0 ],
					"text" : "*~ 0.707"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 448.25, 618.25, 258.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 448.25, 603.25, 63.0, 20.0 ],
					"text" : "<ezdac~>",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 398.0, 603.25, 48.25, 48.25 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 536.0, 556.25, 78.0, 20.0 ],
					"text" : "<live.gain~>",
					"textcolor" : [ 0.870588, 0.415686, 0.062745, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 398.0, 546.25, 136.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "signal", "", "", "" ],
					"patching_rect" : [ 397.952475247524944, 393.0, 345.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "5. A Dirty Monophonic Synth"
				}
