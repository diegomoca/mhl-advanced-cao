...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.0, 586.507945597171783, 151.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 327.0, 556.952382206916809, 35.0, 22.0 ],
					"text" : "out 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 282.0, 556.952382206916809, 35.0, 22.0 ],
					"text" : "out 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 192.0, 476.0, 42.0, 22.0 ],
					"text" : "out~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 594.769840617974637, 476.0, 150.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 843.952475247524944, 361.904767513275146, 167.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 636.833333333333371, 441.0, 59.0, 22.0 ],
					"text" : "mute 1, 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 780.0, 358.5, 59.0, 22.0 ],
					"text" : "mute 0, 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 852.682634112976757, 420.031745970249176, 58.0, 22.0 ],
					"text" : "r mute.all"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 780.0, 458.0, 56.0, 22.0 ],
					"text" : "thispoly~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 296.0, 380.0, 21.0, 20.0 ],
					"text" : "0."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 296.0, 300.0, 21.0, 20.0 ],
					"text" : "1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 488.0, 189.0, 150.0, 20.0 ],
					"text" : "<= 0 - 127 ==> 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 333.5, 79.0, 47.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 1074.0, 35.0, 244.0, 75.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 469.603177309036255, 505.126984655857086, 55.0, 20.0 ],
					"text" : "<outlet>",
					"textcolor" : [ 0.870588, 0.415686, 0.062745, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 353.365081369876862, 9.0, 47.0, 20.0 ],
					"text" : "<inlet>",
					"textcolor" : [ 0.870588, 0.415686, 0.062745, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 51.095237910747528, 13.0, 127.0, 74.0 ],
					"text" : "Monophonic\nSynth\nEngine",
					"textjustification" : 2
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 586.365081369876862, 50.0, 297.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 606.317556617401806, 72.0, 268.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 606.317556617401806, 35.0, 425.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 586.365081369876862, 13.0, 317.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 469.603177309036255, 520.126984655857086, 272.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 437.603177309036255, 510.126984655857086, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 353.365081369876862, 23.0, 217.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 377.833333333333371, 409.0, 278.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 192.0, 252.0, 607.0, 22.0 ],
					"text" : "t f b b"
				}
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 0, 56.829848072438409, 0.503940315707987, 0, 97.558391660546363, 0.262048639090936, 0, 241.528057023682152, 0.25532944321681, 0, 356.135488003547266, 0.0, 0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 321.365081369876862, 13.0, 30.0, 30.0 ]
				}
...
, 			{
				...
				"bootpath" : "~/Documents/Universidad/WS 23/24/CAO/Week-2/bach-poly-boiler-patches-master",
				"type" : "GIFf",
				"implicit" : 1
			}
, 			{
